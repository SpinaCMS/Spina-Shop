# Contributing to Spina Shop

First of all, you're awesome! Thanks for taking the time to contribute to `Spina Shop`.
...
```sh
# Fork the repository
$ git clone https://github.com/your_username/Spina-Shop.git
$ cd Spina-Shop
$ git checkout -b feature/feature_name
# Code
# Run tests
$ git add .
$ git commit -m "Adding products support."
$ git push
