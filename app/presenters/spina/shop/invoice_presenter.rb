module Spina::Shop
  class InvoicePresenter
    ...
    delegate :customer_name, :address_1, :postal_code, :city, :number, :customer_number, :date, :identity_name, :invoice_number, :identity_details, :country_name, :vat_id, to: :invoice
