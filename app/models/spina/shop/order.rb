...
module Spina::Shop
  class Order < ApplicationRecord
    ...
    scope :to_process, -> { received.where(cancelled_at: nil, failed_at: nil, shipped_at: nil, picked_up_at: nil, refunded_at: nil).where("paid_at IS NOT NULL OR payment_method = 'postpay'") }
